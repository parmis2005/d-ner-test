        ...
        <div className="mt-14 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {REVIEWS.map((review, i) => (
            <Reveal key={review.name} delay={i * 0.08}>
              <div className="flex h-full flex-col rounded-2xl border border-white/10 bg-charcoal p-6 shadow-lg shadow-black/20 transition-all hover:-translate-y-1 hover:border-fire/30">
